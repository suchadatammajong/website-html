...
include('conn.php');?>
	...
	<body>
		...
		<div class="inputGroup inputGroup1">
			...
			<input type="text" id="username" class="form-control" name="username" aria-describedby="username" placeholder="Username">
		</div>
		...
		<hr class="shine">
		<p class="text-center">ยังไม่เป็นสมาชิกใช่ไหม คลิ๊กที่นี่เพื่อ <a href="signup.php">สมัครสมาชิก</a></p>
	</form>
	<!-- partial -->
